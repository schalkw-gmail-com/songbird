...
class PageAdminController extends CRUDController
{
    ...
    public function listAction()
    {
        ...
        $rootMenuItems = $this->getDoctrine()->getRepository('SongbirdNestablePageBundle:Page')->findParent();
    ...
    public function reorderAction()
    {
        ...
        try {
            ...
            $message = $this->get('translator')->trans('flash_reorder_edit_success', array(), 'SongbirdNestablePageBundle');
        }
        catch (\Exception $e) {
